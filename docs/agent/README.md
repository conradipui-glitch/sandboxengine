...
Минимальные правила: делай один bounded-шаг; не изменяй state моделью напрямую; запускай `npm run verify`; сохраняй незавершённость и следующий шаг в handoff.
