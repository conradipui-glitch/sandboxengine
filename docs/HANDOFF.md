...
Текущий блок: **M03 DONE (library + HTTP + proxy). Следующее: M04 — общий renderer сайта и preview entrypoint. OPEN: engine deploy на VPS и ролевые C18-проверки.**
...
Следующее: M04 — общий renderer сайта и preview entrypoint.
