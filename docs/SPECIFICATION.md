...
B00: **не принят**; baseline входа зафиксирован отдельно. B01: **bootstrap-срез начат**, но полный B01 (схемы, fixtures, генерация API/Skill и все приёмочные проверки) не принят. B02–B13: **не начаты**. Все T01–T37: **не выполнены**. Этот файл — ТЗ, а не отчёт о готовом движке.
