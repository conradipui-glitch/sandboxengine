...
const MESSAGES: Readonly<Record<string, string>> = Object.freeze({
  ...
  PUBLICATION_SLUG_CONFLICT:
    "Адрес миссии на сайте уже занят другой историей: измените адрес в оформлении миссии и опубликуйте снова.",
  ...
  // Локальный сервер мастерской не отвечает: этим кодом отвечает собственный
  // прокси Studio на 503 — автору нужен следующий шаг, а не код стенда.
  CONTROL_UNAVAILABLE: "Сервер мастерской не отвечает: проверьте соединение и повторите.",
  ...
  // Удаление (DELETE-01). Тексты говорят, что именно не произошло, и что делать.
  QUEST_PUBLISHED: "Миссия опубликована: сначала снимите её с публикации в панели «Публикация», затем удаляйте.",
  PROJECT_HAS_PUBLISHED_QUESTS: "В проекте есть опубликованные миссии: сначала снимите их с публикации, затем удаляйте проект.",
  QUEST_REVISION_CONFLICT: "Миссия изменилась после открытия подтверждения: ничего не удалено — обновите список миссий и подтвердите заново.",
  PROJECT_REVISION_CONFLICT: "Проект изменился после открытия подтверждения: ничего не удалено — обновите и подтвердите заново.",
  PROJECT_QUESTS_CHANGED: "Состав миссий проекта изменился после открытия подтверждения: ничего не удалено — обновите список и подтвердите заново.",
  INVALID_QUEST_DELETE_REQUEST: "Удаление миссии отклонено: неверные версии черновика или документа истории.",
  INVALID_PROJECT_DELETE_REQUEST: "Удаление проекта отклонено: неверные версии или состав миссий.",
  IDEMPOTENCY_KEY_REUSED: "Этот ключ повторной отправки уже использован с другими данными: обновите страницу и повторите."
});
